...
\item Générer des labels lisibles (ex: \texttt{switch-merchant-onboarding} → ``Switch - Merchant Onboarding''),
...
\item \textbf{Extensible} : Plus de 400 nœuds natifs pour intégrer d'autres outils (Jira, Slack, email).
