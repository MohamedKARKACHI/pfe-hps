...
This document summarizes all the work carried out during my end-of-studies internship, entitled "Test Automation".

Test automation is increasingly valued by organizations. It presents itself as an effective solution to avoid human errors when repeating test executions and to save time. Hence the idea of joining a test automation team at HPS group, one of the major electronic payment software publishers. My mission during this internship is the automation of tests for some features of HPS's payment solution.

To achieve my goals and accomplish my mission, it was essential to follow a set of steps: starting with training, then defining the test environment, analyzing technical specification documents, designing tests and data sets, implementing test scenarios, manually executing tests before automating them, and finally writing the report as the mission progressed.

Beyond classical automation, this project introduces an innovative approach: the development of a \textbf{QA Cypress Generator Dashboard}, a full-stack platform powered by \textbf{AI (Mistral)} and \textbf{workflow orchestration (n8n)}, enabling QA testers to generate, execute, and monitor Cypress E2E test scripts without writing a single line of code.

\vspace{10pt}
\textbf{Keywords :} Test Automation, Cypress, React, Node.js, PowerCARD, Quality Assurance, AI, n8n, Microservices
}
