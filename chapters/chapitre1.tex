...
\textit{Dans cette partie, nous allons introduire l'organisme d'accueil, ses missions et son secteur d'activité.}
...
Avec des filières situées en Europe, au Moyen-Orient et en Afrique, HPS Group dessert plus de 350 clients dans plus de 85 pays sur 5 continents.

\begin{table}[H]
\centering
\caption{Chiffres clés d'HPS}
...
Pays & Plus de 85 \\
Continents & 5 \\
Bureaux & Casablanca, Dubaï, Europe, Singapore, Lausanne \\
\bottomrule
\end{tabularx}
\end{table}
