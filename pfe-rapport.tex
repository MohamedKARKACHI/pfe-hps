...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{} % Image missing: \includegraphics[width=4.5cm,keepaspectratio]{emsi-6.png}
\fancyhead[R]{\includegraphics[height=1cm,keepaspectratio]{page00_img01.jpeg}}
\renewcommand{\headrulewidth}{0.5pt}
\fancyfoot[R]{Page \thepage\ sur \pageref{LastPage}}

% ── Chapter/Section styling ──
\titleformat{\chapter}[display]
  {\raggedright\color{chaptercolor}\fontsize{18}{22}\bfseries\selectfont}
  {Chapitre \thechapter\ :}
  {1ex}
  {}
\titleformat{name=\chapter,numberless}[display]
  ...
  {}
  {0pt}
  {\centering\color{chaptercolor}\fontsize{24}{28}\bfseries\selectfont}
